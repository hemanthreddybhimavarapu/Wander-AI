...
const KNOWN_LANDMARKS: Record<string, { places: FamousPlace[]; tagline: string; bestTime: string; currency: string; language: string; timezone: string; styles: string[] }> = {
  ...
  hyderabad: {
    ...
    places: [
      { id: 'hyd-1', number: '01', name: 'Charminar & Laad Bazaar', category: '1591 Monument & Mosque', description: 'The four-minaret symbol of Hyderabad standing in the heart of historic bazaars famed for glass bangles and pearls.', image: 'https://images.unsplash.com/photo-1609137144822-4217112024fa?auto=format&fit=crop&w=1000&q=80', location: 'Old City', recommendedDuration: '2 Hours', curatorTip: 'Sip authentic Irani Chai with Osmania biscuits at Nimrah Cafe right beside the monument.' },
